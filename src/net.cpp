...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Anubiscoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"anubis.website", "192.168.0.100"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"anubiscointools.com", "testnet-seed.anubiscointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Anubiscoin is probably already running."), addrBind.ToString().c_str());
        else
